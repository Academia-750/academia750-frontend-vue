        ...
        <div class="contact-details">
          ...
          <div class="contact-item">
            <div class="contact-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path
                  d="M22 16.92V19.92C22 21.9 20.11 23.48 18.14 23.38C9.81 22.48 3.19 15.84 2.29 7.51C2.19 5.54 3.77 3.65 5.77 3.65H8.77C9.66 3.65 10.41 4.31 10.51 5.19L11.05 8.7C11.13 9.45 10.85 10.19 10.31 10.66L8.87 11.9C10.25 14.53 12.47 16.75 15.1 18.13L16.34 16.69C16.81 16.15 17.55 15.87 18.3 15.95L21.81 16.49C22.69 16.59 23.35 17.34 23.35 18.23"
                  stroke="currentColor"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
          ...
          <div class="contact-item">
            ...
            <div class="contact-info-text">
              ...
              <div class="contact-value">
                Av. Mare Nostrum 6 (entrada por C/Estrella fugaz), 03007,
                Alicante
              </div>
            </div>
          </div>
...
<script>
import SectionWrapper from '@/modules/home/components/bomberos_alicante_landing/Shared/SectionWrapper.vue'
