<template>
  <v-container class="pa-0 menu_estilo" v-bind:class="{ menu_fijado: isFixedMenu }"> 
        ...
        <v-list-item-group>
          ...
          <v-list-item>
            ...
            <v-list-item-subtitle
              @click="$emit('emitScrollToSectionHomePage', 'OurServiceSection')">Qué ofrecemos</v-list-item-subtitle>
          </v-list-item>
          <v-list-item>
            <icon-arrow-link-list-menu />
            <v-list-item-subtitle
              @click="$emit('emitScrollToSectionHomePage', 'tarifasSection')">Tarifas</v-list-item-subtitle>
          </v-list-item>
          <v-list-item>
            <icon-arrow-link-list-menu />
            <v-list-item-subtitle
              @click="$emit('emitScrollToSectionHomePage', 'ContactUsForm')">Contáctanos</v-list-item-subtitle>
          </v-list-item>
        </v-list-item-group>
      </v-list>
    </v-navigation-drawer>
