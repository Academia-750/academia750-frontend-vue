export default {
  methods: {
    ...
    async ResetForm() {
      ...
      this.show_reason_text_in_test = true
      this.show_reason_text_in_card_memory = false
      this.show_reason_image_in_test = true
      this.show_reason_image_in_card_memory = false
